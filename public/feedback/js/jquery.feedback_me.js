var en = [], tr=[], ar=[], ku=[], fa=[], ps=[];
en["lang"] = "English";
en["feedback"] = "Feedback";
en["q1"] = "1. Please rate Services Advisor platform (1 bad - 5 very good)";
en["q2"] = "2. Have you found the services you were looking for?";
en["q3"] = "3. Were you satisfied with the service you received from the service provider?";
en["yes"] = "Yes";
en["no"] = "No";
en["send"] = "Send";
en["sending"] = "Sending...";
en["successfull"] = "Feedback sent successfully, thank you!";
en["error"] = "Feedback could not be sent.";

tr["lang"] = "Turkish";
tr["feedback"] = "<span style='font-size:80%'>Geri Bildirim</span>";
tr["q1"] = "1. Lütfen Services Advisor platformunu değerlendiriniz. (1 kötü - 5 çok iyi)";
tr["q2"] = "2. Aradığınız hizmetleri bulabildiniz mi?";
tr["q3"] = "3. Servis sağlayıcıdan aldığınız hizmet beklentilerinizi karşıladı mı?";
tr["yes"] = "Evet";
tr["no"] = "Hayır";
tr["send"] = "Gönder";
tr["sending"] = "Gönderiliyor...";
tr["successfull"] = "Geri bildirim başarıyla gönderildi, teşekkürler!";
tr["error"] = "Geri bildirim gönderilemedi.";

ar["lang"] = "Arabic";
ar["feedback"] = "ردود الفعل";
ar["q1"] = "1. يرجى تقييم منصة مستشار الخدمات (1 سيئ - 5 جيد جدًا)";
ar["q2"] = "2. هل وجدت الخدمات التي كنت تبحث عنها؟";
ar["q3"] = "3. هل كنت راضيًا عن الخدمة التي تلقيتها من مزود الخدمة؟";
ar["yes"] = "نعم";
ar["no"] = "لا";
ar["send"] = "أرسل";
ar["sending"] = "...إرسال";
ar["successfull"] = "تم إرسال التعليقات بنجاح ، شكرا لك!";
ar["error"] = "لا يمكن إرسال التعليقات.";

ku["lang"] = "Kurdish";
ku["feedback"] = "Bersiv&nbsp;&nbsp;&nbsp;&nbsp;";
ku["q1"] = "1. Ji kerema xwe platforma Services Advisor nirx bikin (1 xirab - 5 pir baş)";
ku["q2"] = "2. Ma we xizmetên ku hûn lê digerin dîtin?";
ku["q3"] = "3. Ma hûn ji xizmetên ku we ji pêşkêşvanê xizmeta wergirtî têr bûn?";
ku["yes"] = "Erê";
ku["no"] = "Na";
ku["send"] = "Bişînin";
ku["sending"] = "Şandina...";
ku["successfull"] = "Bersiv bi serkeftî hate şandin, spas!";
ku["error"] = "Bersiv nehatin şandin.";

fa["lang"] = "Farsi";
fa["feedback"] = "بازخورد&nbsp;&nbsp;&nbsp;&nbsp;";
fa["q1"] = "1. لطفا پلت فرم خدمات مشاور (1 بد - 5 بسیار خوب) را ارزیابی کنید";
fa["q2"] = "2. آیا خدمات مورد نظر خود را پیدا کرده اید؟";
fa["q3"] = "3. آیا از خدمتی که از ارائه دهنده خدمات دریافت کرده اید راضی هستید؟";
fa["yes"] = "آره";
fa["no"] = "نه";
fa["send"] = "ارسال";
fa["sending"] = "...در حال ارسال";
fa["successfull"] = "بازخورد با موفقیت ارسال شد ، متشکرم";
fa["error"] = "بازخورد ارسال نشد.";

ps["lang"] = "Pashto";
ps["feedback"] = "فیډبیک&nbsp;&nbsp;&nbsp;&nbsp;";
ps["q1"] = "1. مهرباني وکړئ د خدماتو مشاور پلیټ فارم درجه کړئ (1 خراب - 5 خورا ښه)";
ps["q2"] = "2. ایا تاسو هغه خدمات موندلي چې تاسو یې په لټه کې یاست؟";
ps["q3"] = "3. ایا تاسو د هغه خدمت سره رضایت لرئ چې تاسو یې د خدمت چمتو کونکي څخه ترلاسه کوئ؟";
ps["yes"] = "هو";
ps["no"] = "نه";
ps["send"] = "ولېږئ";
ps["sending"] = "...لیږل";
ps["successfull"] = "تاثر په بریالیتوب سره ولیږل شو ، مننه!";
ps["error"] = "تاثر ونه لیږل شو";
...
var fm = (function ($) {
	...
	function validateFeedbackForm(event, position) {
		...
		if ((fm_options.name_required === true && $fm_content.find(".feedback_name").val() === "") ||
				...
				(fm_options.radio_button_list_required === true && $fm_content.find("input[name=feedback_radio_2]:checked").val() === undefined) ||
				(fm_options.radio_button_list_required === true && $fm_content.find("input[name=feedback_radio_3]:checked").val() === undefined)) {
			return false;
		}
		return true;
	...
	function appendFeedbackToBody(fm_options) {
		...
		if(fm_options.lang == "en")
			translation = en;
		else if(fm_options.lang == "tr")
			translation = tr;
		else if(fm_options.lang == "ar")
			translation = ar;
		else if(fm_options.lang == "ku")
			translation = ku;
		else if(fm_options.lang == "fa")
			translation = fa;
		else if(fm_options.lang == "ps")
			translation = ps;
		else 
			translation = en;
		...
		if (fm_options.show_radio_button_list === true) {
			radio_button_list_html = "<li><div class=\"radio_button_list_title_wrapper\"><div class=\"radio_button_list_title\">" + translation["q1"] + radio_button_list_asterisk + "</div></div><div class=\"radio_button_list_wrapper\">";
			...
			radio_button_list_html += "<li><div class=\"radio_button_list_title_wrapper\"><div class=\"radio_button_list_title\">"+translation["q2"] + radio_button_list_asterisk +"</div></div><div class=\"radio_button_list_wrapper\">";
			radio_button_list_html += "    <div class=\"radio_button_wrapper\">";
			radio_button_list_html += "        <input value=\"1\" type=\"radio\" name=\"feedback_radio_2\" class=\"feedback_radio_21\" " + radio_button_list_required + "\/>";
			radio_button_list_html += "        <label for=\"feedback_radio_21\">"+translation["yes"]+"<\/label>";
			radio_button_list_html += "    <\/div>";
			radio_button_list_html += "    <div class=\"radio_button_wrapper\">";
			radio_button_list_html += "        <input value=\"2\" type=\"radio\" name=\"feedback_radio_2\" class=\"feedback_radio_22\"\/>";
			radio_button_list_html += "        <label for=\"feedback_radio_22\">"+translation["no"]+"<\/label>";
			radio_button_list_html += "    <\/div>";
			radio_button_list_html += "<\/div> </li>";

			radio_button_list_html += "<li><div class=\"radio_button_list_title_wrapper\"><div class=\"radio_button_list_title\">"+translation["q3"] + radio_button_list_asterisk +"</div></div><div class=\"radio_button_list_wrapper\">";
			radio_button_list_html += "    <div class=\"radio_button_wrapper\">";
			radio_button_list_html += "        <input value=\"1\" type=\"radio\" name=\"feedback_radio_3\" class=\"feedback_radio_31\" " + radio_button_list_required + "\/>";
			radio_button_list_html += "        <label for=\"feedback_radio_31\">"+translation["yes"]+"<\/label>";
			radio_button_list_html += "    <\/div>";
			radio_button_list_html += "    <div class=\"radio_button_wrapper\">";
			radio_button_list_html += "        <input value=\"2\" type=\"radio\" name=\"feedback_radio_3\" class=\"feedback_radio_32\"\/>";
			radio_button_list_html += "        <label for=\"feedback_radio_32\">"+translation["no"]+"<\/label>";
			radio_button_list_html += "    <\/div>";
			radio_button_list_html += "<\/div> </li>";
		...
		if (fm_options.show_form === true) {
			form_html = '<form class="feedback_me_form">'
				...
				+		'<li>	<button type="submit" onclick="fm.stopPropagation(event);fm.sendFeedback(event,\'' + fm_options.position + '\');" class="feedback_submit ' + bootstrap_btn + '">' + translation["send"] + '</button> </li>'
				+	'</ul>'
				+	'</form>';
		}
		...
		$('body').append('<div onclick="fm.stopPropagation(event);fm.triggerAction(event,\'' + fm_options.position + '\');" class="feedback_trigger feedback_trigger_closed ' + fm_options.position + jQueryUIClasses1 + fm_class + jquery_class + bootstrap_class + bootstrap_hero_unit + '">'
				+	'<span class="feedback_trigger_text">' + translation["feedback"]
				+	'</span></div>');
		...
		$('body').append('<div class="feedback_content feedback_content_closed ' + fm_options.position + email_feedback_content_class + radio_button_list_class + jQueryUIClasses2 + fm_class + jquery_class + bootstrap_class + bootstrap_hero_unit + '">'
							+ '<div class="feedback_title ' + jQueryUIClasses1 + jQueryUIClasses3 + '" style="font-size:17px!important;">'
							+	'<span class="' + jQueryUIClasses4 + '">' + translation["feedback"] + '</span>'
							+ '</div>'
							+  form_html
							+  iframe_html
	...
	function clearInputs(event) {
		...
		$fm_content.find(".feedback_me_form input[name=feedback_radio_2]").prop('checked', false);
		$fm_content.find(".feedback_me_form input[name=feedback_radio_3]").prop('checked', false);
	}
	...
	function sendFeedback(event, position) {
		...
		dataArray = {
			...
			radio_list_value_2: $fm_content.find(".feedback_me_form input[name=feedback_radio_2]:checked").val(),
			radio_list_value_3: $fm_content.find(".feedback_me_form input[name=feedback_radio_3]:checked").val(),
				...
				if (fm_options.delayed_close === true) {
					if (fm_options.delayed_options.custom_html_success === undefined) {
						...
						$("body").append('<div ' + st + ' class="feedback-delayed-dlg success" onclick="fm.stopPropagation(event);"><span class="feedback-dlg-close" onclick="fm.closeFeedbackDelayedDlg();">X</span><span class="feedback-success-message">' +
							'<span class="feedback-success-fail-message-inner"><span>' + translation["successfull"] + '</span></span></span></div>');
				...
				if (fm_options.delayed_close === true) {
					if (fm_options.delayed_options.custom_html_fail === undefined) {
						...
						$("body").append('<div ' + st + ' class="feedback-delayed-dlg fail" onclick="fm.stopPropagation(event);"><span class="feedback-dlg-close" onclick="fm.closeFeedbackDelayedDlg();">X</span><span class="feedback-fail-message">' +
							'<span class="feedback-success-fail-message-inner"><span>' + translation["error"] + '</span></span></span></div>');
	...
	function init(options) {
		...
		var default_options = {
			...
			delayed_options : {
				...
				sending : "Sending...",
				send_fail : "Sending could not be sent.",
